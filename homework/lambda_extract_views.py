...
# Set username - must match the bucket created in the notebook
# Bucket name: <username>-wikidata
S3_WIKI_BUCKET = "sabira-wikidata"

def lambda_handler(event, context):
    """
    Lambda handler for Wikipedia page views ETL pipeline.

    Optional date parameter: {"date": "2025-11-20"}
    ...
    # Extract: fetch from Wikipedia API (pageviews top endpoint)
